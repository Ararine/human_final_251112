const UserDetailInfo = ({ detail, setDetail, handleDetailSave }) => {
      ...
      <section className="profile-section">
        ...
        <div className="profile-field">
          ...
          >
            ...
            <option value="자세교정">자세 교정</option>
            <option value="근력향상">근력 향상</option>
            <option value="상태유지">상태 유지</option>
          </select>
        </div>
        ...
        {/* 저장 버튼 */}
        <button className="btn-primary" onClick={handleDetailSave}>
          수정하기
        </button>
      </section>
    </>
