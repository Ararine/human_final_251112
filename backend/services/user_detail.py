from models.user_detail import (
    get_user_detail_info_by_id,
    update_user_detail_info_by_id,
    create_user_detail_info
)

def service_get_user_detail(user_id: int):
    return get_user_detail_info_by_id(user_id)


def service_update_user_detail(user_id: int, body: dict):
...
def service_create_user_detail(user_id: int, body: dict):
